...
public class FinancialCard {
    ...
    //获取银行卡卡号指令
    public static byte[] getCardNumberCmdBytes() {
        //return new byte[]{0x00, (byte)0xB2, 0x01, 0x14, 0x00};
        //return new byte[]{0x00, (byte)0xB2, 0x02, 0x0C, 0x00};
        return new byte[]{0x00, (byte)0xB2, 0x01, 0x0C, 0x1d};
    }
...
//            }
    ...
    public static String extractCardNumberFromeRturnBytes (byte[] returnBytes) {
        ...
        int startIndex = 8;
        int endIndex = stringBuilder.indexOf("D2");
        if (startIndex < endIndex) {
            String str = stringBuilder.substring(startIndex, endIndex);
